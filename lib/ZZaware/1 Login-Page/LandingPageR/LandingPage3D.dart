...
class LandingPage3D extends StatelessWidget {
  const LandingPage3D({super.key});
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const Text(
                      "Der Ort für deine\ninneren Gedanken.",
                      style: TextStyle(fontSize: 56, fontWeight: FontWeight.w900, color: AppColors.textMain, height: 1.1),
                    ),
                    const SizedBox(height: 20),
                    const Text(
                    ...
                    Row(
                      children: [
                        ...
                        TextButton.icon(
                            ...
                            label: const Text("Demo ansehen", style: TextStyle(color: AppColors.textMain))
                        )
                      ],
                    ),
                    const SizedBox(height: 40),
                    Row(
                      children: const [
                        ...
                        Text("Keine Kreditkarte nötig", style: TextStyle(color: AppColors.textGrey, fontSize: 12)),
                        SizedBox(width: 20),
                        Icon(Icons.check_circle, size: 16, color: AppColors.tealPrimary), SizedBox(width: 5),
                        Text("Datenschutz garantiert", style: TextStyle(color: AppColors.textGrey, fontSize: 12)),
                      ],
                    )
                  ],
                ),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              const Text("Alles was du brauchst.", style: TextStyle(fontSize: 36, fontWeight: FontWeight.bold, color: AppColors.textMain)),
              ...
              Expanded(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 20),
                    const Text("Lerne dich selbst kennen.", style: TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: AppColors.textMain)),
                    const SizedBox(height: 20),
                    const Text(
                      ...
                      style: TextStyle(fontSize: 18, color: AppColors.textGrey, height: 1.6),
                    ),
          ...
          child: Row(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: const [
                  Text("aware.", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold, color: AppColors.textMain)),
                  SizedBox(height: 10),
                  Text("Made with ❤️ for Mindfulness.", style: TextStyle(color: AppColors.textGrey)),
                ],
              ),
              const Spacer(),
...
class _NavbarLink extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextButton(
      onPressed: () {},
      child: Text(title, style: const TextStyle(color: AppColors.textMain, fontSize: 16)),
    );
  }
}
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 10),
          Text(desc, style: const TextStyle(fontSize: 15, color: AppColors.textGrey, height: 1.5)),
        ],
      ),
    );
  }
    ...
    return Column(
      ...
      children: [
        ...
        ...links.map((l) => Padding(
          ...
          child: Text(l, style: const TextStyle(color: AppColors.textGrey)),
        ))
      ],
    );
  }
