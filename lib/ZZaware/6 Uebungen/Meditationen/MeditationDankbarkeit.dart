                ...
                Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      ...
                      child: Padding(
                        padding: const EdgeInsets.only(bottom: 16.0), // Abstand nach unten zum Datum/Inhalt
                        child: Row(
                          mainAxisSize: MainAxisSize.min, // Row nimmt nur so viel Platz wie nötig
                          crossAxisAlignment: CrossAxisAlignment.center, // Zentriert Text vertikal zum Icon
                          children: [
                            IconButton(
