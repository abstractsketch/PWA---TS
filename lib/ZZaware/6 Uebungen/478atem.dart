      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            Text(_statusText, style: const TextStyle(fontSize: 32, fontWeight: FontWeight.bold, color: AppColors.tealPrimary)),
            const SizedBox(height: 10),
            Text("$_counter s", style: const TextStyle(fontSize: 20, color: AppColors.orangeStart),),
