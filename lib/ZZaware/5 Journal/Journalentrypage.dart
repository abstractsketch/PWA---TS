...
class Journalentrypage extends StatefulWidget {
  ...
  @override
  State<Journalentrypage> createState() => JournalentrypageState();
}
  ...
  Future<void> _checkForExistingEntry() async {
    ...
    try {
      ...
      final QuerySnapshot snapshot = await FirebaseFirestore.instance
          ...
          .where('tag', isEqualTo: 'journal') // Wichtig, damit wir nicht andere Eintragstypen laden
          .limit(1)
          .get();
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    TextField(
                      ...
                      style: const TextStyle(color: AppColors.tealDark, fontWeight: FontWeight.bold), // <-- Text Farbe
                      cursorColor: AppColors.tealPrimary,
                      decoration: InputDecoration(
                        filled: true,
                        fillColor: AppColors.cardWhite, 
                        hoverColor: Colors.transparent, // <--- WICHTIG: Kein Grau bei Hover
                    ...
                    Expanded(
                      child: TextField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: "Heute ist viel passiert, ich war...",
                          hintStyle: TextStyle(color: AppColors.greyText.withOpacity(0.7)),
                          border: OutlineInputBorder(
                            borderRadius: BorderRadius.circular(12),
                            borderSide: BorderSide.none,
